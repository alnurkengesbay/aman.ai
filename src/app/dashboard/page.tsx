          ...
          <div className="grid lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="border border-border rounded-2xl p-6 bg-background/60 backdrop-blur-sm">
              ...
              <p className="text-xs text-muted-foreground mb-4">
                Пройдите первую диагностику для расчёта
              </p>
              <div className="h-2 bg-secondary rounded-full overflow-hidden">
                <div className="h-full w-0 bg-foreground rounded-full transition-all duration-500" />
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="border border-border rounded-2xl p-5 bg-background/60 backdrop-blur-sm">
                ...
                <div className="space-y-3">
                  <TaskItem title="Заполнить профиль" completed={false} />
                  <TaskItem title="Пройти первый опросник" completed={false} />
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="border border-border rounded-2xl p-5 bg-background/60 backdrop-blur-sm">
              ...
              <div className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="text-sm text-muted-foreground mb-1">Нет активности</p>
                <p className="text-xs text-muted-foreground">Начните с прохождения диагностики</p>
              </div>
            </div>
            ...
            <div className="border border-border rounded-2xl p-5 bg-background/60 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-3 gap-4">
                <MiniMetric label="HRV" value="—" unit="ms" trend={null} />
                <MiniMetric label="SpO2" value="—" unit="%" trend={null} />
                <MiniMetric label="Стресс" value="—" unit="%" trend={null} />
              </div>

              {/* Graph placeholder */}
              <div className="mt-4 h-24 border border-dashed border-border rounded-xl flex items-center justify-center">
                <p className="text-xs text-muted-foreground">График появится после первых данных</p>
              </div>
            </div>
          </div>
        </div>
